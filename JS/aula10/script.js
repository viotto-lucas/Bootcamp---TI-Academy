...
// // O método search() procura pela ocorrência e retornando a posição na cadeia da string
...
const coisaNomes = ( name, novoNome, index )=>{
    ...
    console.log("Quantidade de elementos do array..: ", name.lenght);
    console.log(`Você escolheu o indice ${index} que é o elemento ${name [index]}`);
    console.log(`O nome ${novoNome} foi inserido no array`);
    name.push(novoNome);
    console.log("A quantidade de elementos atual do array é de..: ", name.lenght);
}
